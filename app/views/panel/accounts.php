...
<section class="container mt-4">
  ...
  <div class="mb-2 d-flex gap-3 position-relative">
    ...
    <?php if (isset($data['message']['success'])) { ?>
      <div class="d-none position-absolute top-50 start-50 translate-middle col-md-8 col-lg-6 col-xl-4 mx-auto alert alert-success text-center small p-1 rounded-0" id="alert_create_account"><?php echo $data['message']['success'] ?></div>
    <?php } ?>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo 'panel/accounts/' . $data['user_id'] ?>" method="POST" id="add_account">
